...
const dailyURL = 'https://api.dailymotion.com/videos?channel=news&fields=id,thumbnail_360_url,title,embed_url,description&thumbnail_ratio=widescreen&language=eng';
                ...
                {/*------------FIM DO MOBILE-------------*/}
                    ...
                    {/* --------------- // CARROSSEL DAS IMAGENS ---------------- */}
                        ...
                        <div className="col-lg-12 display-desktop" style={{marginTop: -120 + "px",  zIndex: 2}}>
                            <h4 className="mt-5 ml-2" style={{color: 'white'}}> News </h4>
                                ...
                                <div>
                                    ...
                                    <div id="page-content-wrapper" className=" display-mobile" style={{position: "relative", top: "44px"}}>
                                        ...
                                        <div className="mt-3" style={{marginLeft: "1rem"}}>
                                            <h4 style={{color: "white", zIndex:80, position: "relative"}}>News</h4>
                                            <hr style={{
