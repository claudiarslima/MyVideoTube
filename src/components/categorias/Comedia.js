...
const finalURL = `https://www.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&videoCategoryId=23&key=AIzaSyDhsERNhsX0wnS3dW-Vc9eMykFvrLKeqQ8&maxResults=3`
                ...
                {/*------------FIM DO MOBILE-------------*/}
                    ...
                    {/* --------------- // CARROSSEL DAS IMAGENS ---------------- */}
                        ...
                        <div className="col-lg-12 display-desktop" style={{marginTop: -120 + "px",  zIndex: 2}}>
                            <h4 className="mt-5 ml-2" style={{color: 'white'}}> Comedy </h4>
                                ...
                                <div>
                                    ...
                                    <div id="page-content-wrapper" className=" display-mobile" style={{position: "relative", top: "44px"}}>
                                        ...
                                        <div className="mt-3" style={{marginLeft: "1rem"}}>
                                            <h4 style={{color: "white", zIndex:80, position: "relative"}}>Comedy</h4>
                                            <hr style={{
