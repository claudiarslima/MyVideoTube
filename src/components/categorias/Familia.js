...
const finalURL = `https://www.googleapis.com/youtube/v3/search?key=AIzaSyDhsERNhsX0wnS3dW-Vc9eMykFvrLKeqQ8&channelId=UC3KknIJZXRygH2pZ6MDtGbg&part=snippet&viewCount&safeSearch=strict&maxResults=3`;
const array_geral = [];
                ...
                {/*------------FIM DO MOBILE-------------*/}
                    ...
                    {/* --------------- // CARROSSEL DAS IMAGENS ---------------- */}
                        ...
                        <div className="col-lg-12 display-desktop" style={{marginTop: -120 + "px",  zIndex: 2}}>
                            <h4 className="mt-5 ml-2" style={{color: 'white'}}> Family </h4>
                                ...
                                <div>
                                    ...
                                    <div id="page-content-wrapper" className=" display-mobile" style={{position: "relative", top: "44px"}}>
                                        ...
                                        <div className="mt-3" style={{marginLeft: "1rem"}}>
                                            <h4 style={{color: "white", zIndex:80, position: "relative"}}>Family</h4>
                                            <hr style={{
