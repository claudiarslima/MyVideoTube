...
class Registo extends Component {
    ...
    render() {
        ...
        return(
            ...
            <header className="text-white" style={{height: 100 + '%', minHeight: 550 + 'px'}}>
                <div className="container my-auto text-center d-flex" id="hero_title_container" style={{height: '100%', width: '100vw', minHeight: '550px', maxWidth: '100%'}}>
                    {/*style="height: 100%; max-width: 100%"*/}
                    {/* Image Map Generated by http://www.image-map.net/ */}
                    <section style={{zIndex: 0, position: 'absolute', left: 0, width: 100 + '%', height: 100 + '%', minHeight: 550 + 'px',backgroundColor: '#2d142c'}}>
